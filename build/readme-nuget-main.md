...
- [Code Editor](https://github.com/leekelleher/umbraco-contentment/blob/contrib/docs/editors/code-editor.md) - a code snippet editor, _(using the Monaco library that is bundled with Umbraco)._
...
- [Text Input](https://github.com/leekelleher/umbraco-contentment/blob/contrib/docs/editors/text-input.md) - a textstring editor, configurable with HTML5 options.
...
[Documentation for each of the components](https://github.com/leekelleher/umbraco-contentment/blob/contrib/docs/) - with screenshots, use-cases and code examples can be found on the GitHub repository.
