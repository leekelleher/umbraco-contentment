...
import type { GetElementTypesData, GetElementTypesResponse, GetElementTypesError, PostDataListEditorData, PostDataListEditorResponse, PostDataListEditorError, PostDataPickerEditorData, PostDataPickerEditorResponse, PostDataPickerEditorError, GetDataPickerSearchData, GetDataPickerSearchResponse, GetDataPickerSearchError, PostDataPickerSearchData, PostDataPickerSearchResponse, PostDataPickerSearchError, GetAssembliesDataData, GetAssembliesDataResponse, GetAssembliesDataError, GetEnumsDataData, GetEnumsDataResponse, GetEnumsDataError, GetConfigurationData, GetConfigurationResponse, GetConfigurationError } from './types.gen';
...
export class ContentBlocksService {
    public static getElementTypes<ThrowOnError extends boolean = true>(options?: Options<GetElementTypesData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<GetElementTypesResponse, GetElementTypesError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
...
export class DataPickerService {
    ...
    public static postDataPickerSearch<ThrowOnError extends boolean = true>(options?: Options<PostDataPickerSearchData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<PostDataPickerSearchResponse, PostDataPickerSearchError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
...
export class MetaService {
    public static getConfiguration<ThrowOnError extends boolean = true>(options?: Options<GetConfigurationData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<GetConfigurationResponse, GetConfigurationError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
