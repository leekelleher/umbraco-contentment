...
namespace Our.Umbraco.Contentment.DataEditors
{
    ...
    {
        public override bool IsConverter(PublishedPropertyType propertyType) => propertyType.EditorAlias.InvariantEquals(RadioButtonListDataEditor.DataEditorAlias);
