...
namespace Our.Umbraco.Contentment.DataEditors
{
    [DataEditor(
        ...
        Icon = DataEditorIcon)]
    public class ElementsDataEditor : DataEditor
    {
        ...
        internal const string DataEditorViewPath = Constants.Internals.EditorsPathRoot + "elements.html";
        ...
        public ElementsDataEditor(ILogger logger)
            : base(logger)
        { }
