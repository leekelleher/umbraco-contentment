...
This is a demo website, using Umbraco v10.0.0, to showcase the features of the Contentment package.
...
Umbraco version `10.0.0` is intentionally used, as that is the minimum version of Umbraco that the latest version of Contentment supports.
