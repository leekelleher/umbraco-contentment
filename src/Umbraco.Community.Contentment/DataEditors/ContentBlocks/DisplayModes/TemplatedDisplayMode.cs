...
{
    internal class TemplatedDisplayMode : IContentBlocksDisplayMode
    {
        private readonly IIOHelper _ioHelper;

        public TemplatedDisplayMode(IIOHelper ioHelper)
        {
            _ioHelper = ioHelper;
        }
        ...
        public string Description => "Blocks will be rendered with custom markup.";
        ...
        public Dictionary<string, object> DefaultConfig => new Dictionary<string, object>
        {
            { "allowCopy", Constants.Values.True },
            { "allowCreateContentTemplate", Constants.Values.True },
            { ContentBlocksConfigurationEditor.DisplayMode, "templated" },
...
<pre><code>{
    ""elementType"": ""..."", // Guid of element-type
    ""key"": ""..."", // Guid of block
    ""value"": {
        // alias/value pairs of properties
        ""..."": ""..."",
    }
}</code></pre>
