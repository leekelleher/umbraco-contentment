...
namespace Umbraco.Community.Contentment.DataEditors
{
    ...
    public sealed class UmbracoDictionaryDataListSource : IDataListSource
    {
        ...
        public string Description => "Select a parent Umbraco dictionary item to populate the data source with its child items.";
        ...
        public IEnumerable<ConfigurationField> Fields => new[]
        {
            new ConfigurationField
            {
                ...
                View = IOHelper.ResolveUrl(DictionaryPickerDataEditor.DataEditorViewPath),
        ...
        {
            if (config.TryGetValueAs("item", out JArray array) &&
                array.Count > 0 &&
                ...
                id > 0)
            {
                ...
                if (parent != null)
                {
                    ...
                    return _localizationService
                        ...
                        {
                            Name = x.Translations.FirstOrDefault(t => t.Language.IsoCode.InvariantEquals(cultureName) || t.Language.IsDefault)?.Value ?? x.ItemKey,
                            Value = x.ItemKey,
                            Icon = this.Icon,
