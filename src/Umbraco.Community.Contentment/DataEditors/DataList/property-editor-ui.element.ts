...
import { UmbPropertyEditorConfig, UmbPropertyEditorConfigCollection } from "@umbraco-cms/backoffice/property-editor";
    ...
    async #gotEditorUI(manifest?: ManifestPropertyEditorUi | null): Promise<void> {
        ...
        if (el) {
            ...
            if (this._element) {
                ...
                if (this.config) {
                    this._element.config = new UmbPropertyEditorConfigCollection(this.config);
                }
            }
