...
- The main [`contrib`](https://github.com/leekelleher/umbraco-contentment/tree/contrib) branch is where the latest work happens. This defaults to the most recent version of Contentment, (at the time of writing, this is v6.x).
...
- The [`dev/v6.x`](https://github.com/leekelleher/umbraco-contentment/tree/dev/v6.x) branch is for Contentment **v6.x** (current) releases, this targets both Umbraco **v16.0.0** and **v17.0.0**.
